...
import { H3Event, toResponse, useSession } from "h3-v2";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Cepvjuv6.js");
...
const manifest = { "341bda91c906ae8abd175235a7a89e4e8d37acad3f3899ef117b930b38e91d62": {
  functionName: "closeBloodRequest_createServerFn_handler",
  importer: () => import("./assets/public.functions-BG3glOa1.js")
}, "665553fb568304faa6f3a9698048c7b4c94824bec8878e324c5addfe14b09bab": {
  functionName: "closeSosAlert_createServerFn_handler",
  importer: () => import("./assets/public.functions-BG3glOa1.js")
}, "89f029f4fc21ed092423cd54f44fb61078423691288a3a89663a6e0973cd86ea": {
  functionName: "adminLogin_createServerFn_handler",
  importer: () => import("./assets/admin.functions-C5UMRAbL.js")
}, "b778199f0067dc3af0626a35537d9640eabb3a694e5f097e062cd440c74c2c03": {
  functionName: "adminLogout_createServerFn_handler",
  importer: () => import("./assets/admin.functions-C5UMRAbL.js")
}, "071c9034ee157920f00ef33d2423b001609d4735aef36265881dffb10297f9d8": {
  functionName: "adminStatus_createServerFn_handler",
  importer: () => import("./assets/admin.functions-C5UMRAbL.js")
}, "6c55fbec43b50d016f78059baf659efdefc464df2760edbac60d8d332b2258cf": {
  functionName: "adminSetDonorAvailability_createServerFn_handler",
  importer: () => import("./assets/admin.functions-C5UMRAbL.js")
}, "613cf21671274b008a2af86b7f5a57190029b6b69eb385b4b5bef4869480ab8b": {
  functionName: "adminSetStatus_createServerFn_handler",
  importer: () => import("./assets/admin.functions-C5UMRAbL.js")
}, "87fa8faa27fbc4c76dc9dae7d66bb47df38b6b341b6351074a7979f8a5312e46": {
  functionName: "adminDeleteRow_createServerFn_handler",
  importer: () => import("./assets/admin.functions-C5UMRAbL.js")
} };
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-CtePZ7oq.js").then((n) => n.r);
  return {
